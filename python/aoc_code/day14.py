...
# Not needed, only for printing the triplets generated by part 1   
...
#Pairs are counted twice, except in pairs like BCCB, use ceil for the round error 
def count_letters(npairs):
    ...
    for p in npairs.keys():
        ...
        if c2 in result:
            ...
            result[c2]=npairs[p]
    return { k:ceil(result[k]/2) for k in result.keys()}
